...
<div class="panel-body">
    <a href="view.php" class="btn btn-md btn-primary">Go back</a>
    <a href="home.php" style="float: right" class="btn btn-md btn-success">Back to Home Page</a>
    ...
    <tr>
        ...
        <th width="20%">View</th>
            ...
            <?php
                ...
                $query = "select distinct date from attendance inner join stu where attendance.stu_id=stu.stu_id and stu.class_id='5'";
...
<tbody>
    <tr>
        ...
        <th><a href="viewpfive.php?date=<?php echo $val['date'] ?>" class="btn btn-primary" >View</a></th>
