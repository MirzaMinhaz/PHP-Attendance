                    ...
                    <div class="input-group">
                        <select onchange="location = this.options[this.selectedIndex].value;" class="custom-select"
                         id="inputGroupSelect02">
                            ...
                            <option value="indexone.php">Class 1</option>
                            <option value="indextwo.php">Class 2</option>
                            <option value="indexthree.php">Class 3</option>
                            <option value="indexfour.php">Class 4</option>
                            <option value="indexfive.php">Class 5</option>
                        </select>
                    </div>
                </div>
            </div>
