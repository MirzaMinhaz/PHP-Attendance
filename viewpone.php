...
<div class="panel-body">
    <a href="viewone.php" class="btn btn-md btn-primary">Go back</a>
    ...
    <tr>
        ...
        <td>Attendance</td>
            ...
            <?php
                ...
                FROM attendance
                inner join stu on attendance.stu_id=stu.stu_id and stu.class_id='1' and attendance.date=
...
<!-- <div class="card bg-light text-center mb-3">
    <h4 class="m-0 py-3"><strong>Date</strong>:<?php echo $val['date']; ?></h4>
	</div> -->
