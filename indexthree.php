...
<?php
            $query = "select * from stu stu where class_id='3'";
...
<?php
                ...
                if($_SERVER['REQUEST_METHOD']=='POST'){
                    ...
                    $query="select distinct date from attendance inner join stu where attendance.stu_id=stu.stu_id and stu.class_id='3'";
                    $result=$link->query($query);
                    $b=false;
