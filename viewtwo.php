    ...
    <tr>
        ...
        <th width="20%">View</th>
            ...
            <?php
                ...
                $query = "select distinct date from attendance inner join stu where stu.class_id='2'";
...
<tbody>
    <tr>
        ...
        <th><a href="viewptwo.php?date=<?php echo $val['date'] ?>" class="btn btn-primary" >View</a></th>
